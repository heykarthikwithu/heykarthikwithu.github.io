		...
		<div class="row">
            ...
            <div class="col-md-12">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">One of the Top 30 contributors in Drupal, listed in Dries Buytaert (Founder of Drupal) blog - http://buytaert.net/who-sponsors-drupal-development</li>
                    <li class="list-group-item">Selected for the Grant for DrupalCon Asia 2016, and got invitation to attend, behalf of the contribution to Drupal Community - https://events.drupal.org/asia2016/grants­and­scholarships</li>
                    <li class="list-group-item">Have helped for Drupal Core Contributions, here list of core commits helped with - https://www.drupal.org/u/heykarthikwithu/issue-credits/all</li>
                    <li class="list-group-item">Maintainer of modules on drupal.org - http://drupal.org/u/heykarthikwithu</li>
                </ul>
            </div>
		</div>
	</div>
