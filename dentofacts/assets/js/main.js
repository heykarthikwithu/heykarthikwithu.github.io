...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (experienceElement) {
      experienceElement.textContent = `${experienceYears} Years of Experience`;
  }
});
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (window.location.pathname === "/dentofacts/index.html") {
...
document.getElementById("consultationForm").addEventListener("submit", function (event) {
  ...
  // Format message
  const message = `Dentofacts - Online Dental Consultation - Dental Consultation Form\n\n` +
      `Name: ${fullName}\n` +
      `Age: ${age}\n` +
      `Gender: ${gender}\n` +
      `Address: ${address}\n` +
